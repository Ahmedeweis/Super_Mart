...
<script setup>
import img1 from '../../assets/imgs/category/1.webp'
import img2 from '../../assets/imgs/category/2.webp'
import img3 from '../../assets/imgs/category/3.webp'
import img4 from '../../assets/imgs/category/4.webp'
import img5 from '../../assets/imgs/category/5.webp'
import img6 from '../../assets/imgs/category/6.webp'

const categories = [
  { name: 'Toys and Hobby', image: img1 },
  { name: 'Gaming', image: img2 },
  { name: 'Computer', image: img3 },
  { name: 'Health', image: img4 },
